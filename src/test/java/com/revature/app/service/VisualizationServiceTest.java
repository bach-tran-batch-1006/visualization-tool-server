...
// second profile when second test properties file get setup @ActiveProfile("second")
public class VisualizationServiceTest {
	...
	void FindEndpoint() throws Exception {
	     ...
	     mockmvc.perform(get("/find/1")).andExpect(MockMvcResultMatchers.status().isOk());
	}
	
	@Test
	void FindEndpointInvalidVisualizationDoNotExist() throws Exception {
	     mockmvc.perform(get("/find/35")).andExpect(MockMvcResultMatchers.status().isInternalServerError());
	}
	...
	void UpdateEndpointvalidVisualization() throws Exception {
	     ...
	     mockmvc.perform(put("/update/1/newtitle")).andExpect(MockMvcResultMatchers.status().isOk());
	}
	...
	void UpdateEndpointInvalidVisualization() throws Exception {
	     ...
	     mockmvc.perform(put("/update/1/newtitle")).andExpect(MockMvcResultMatchers.status().isInternalServerError());
	}
	...
	void  deleteEndpointvalidVisualization() throws Exception {
	     ...
	     mockmvc.perform(delete("/delete/1")).andExpect(MockMvcResultMatchers.status().isOk());
	}
	
	@Test
	void  deleteEndpointInvalidVisualization() throws Exception {
		
	     mockmvc.perform(delete("/delete/35")).andExpect(MockMvcResultMatchers.status().isInternalServerError());
	}
	...
	void  GetallEndpointvalidVisualizations() throws Exception {
	     ...
	     mockmvc.perform(get("/getall")).andExpect(MockMvcResultMatchers.status().isOk());
	}
